...
struct MONSTERBATTLESYSTEM_API FHopperMovementFlipbooks
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct MONSTERBATTLESYSTEM_API FHopperPunchFlipbooks
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct MONSTERBATTLESYSTEM_API FHopperItemData
{
	GENERATED_BODY()
