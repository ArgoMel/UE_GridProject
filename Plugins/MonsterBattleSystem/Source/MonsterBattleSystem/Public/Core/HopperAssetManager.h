...
UCLASS()
class MONSTERBATTLESYSTEM_API UHopperAssetManager : public UAssetManager
{
	GENERATED_BODY()
public:
...
public:
	 ...
	 */
	UHopperItem* ForceLoadItem(const FPrimaryAssetId& PrimaryAssetId, bool bLogWarning = true) const;
};
