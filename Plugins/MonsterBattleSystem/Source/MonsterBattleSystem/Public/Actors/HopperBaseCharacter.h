 ...
 */
UCLASS()
class MONSTERBATTLESYSTEM_API AHopperBaseCharacter : public APaperCharacter, public IAbilitySystemInterface, public IHopperCharacterInterface
{
	GENERATED_BODY()
	/**********************************
	*         Class Overrides
...
protected:
	...
	void OnDamaged(float DamageAmount, const FHitResult& HitInfo, const struct FGameplayTagContainer& DamageTags, AHopperBaseCharacter* InstigatorCharacter, AActor* DamageCauser);
	...
	virtual void HandleDamage(float DamageAmount, const FHitResult& HitInfo, const FGameplayTagContainer& DamageTags, AHopperBaseCharacter* InstigatorCharacter, AActor* DamageCauser);
